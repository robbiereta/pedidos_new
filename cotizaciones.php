...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <a class="nav-item nav-link active " href="cotizaciones.php">Cotizaciones</a>
    </div>
  </div>
</nav>
...
<h2>Cotizaciones</h2>
    ...
    <input type="text" name="codigo" id="atencion">
    <br>
    <label for="fecha">Con fecha del:</label>
    <input type="date" name="fecha" id="fecha">
    <hr>
    <input type="submit" value="Hacer cotizacion">
    </form>
